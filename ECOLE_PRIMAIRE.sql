...
ALTER PROC NOUVEAU_TRAVAIL
 ...
 LEFT JOIN COURS ON COURS.ID=TRAVAIL.COURS AND  COURS.DESIGNATION='FRANCAIS'  LEFT JOIN DESIGNATION_SALLE ON DESIGNATION_SALLE.ID=TRAVAIL.DESIGNATION_SALLE  AND DESIGNATION_SALLE.LETTRE='A'
  ...
  WHERE DETAILS_TRAVAIL.PERIODE=(SELECT MAX(ID) FROM periode) 
	 ...
	 (@COURS VARCHAR(30),@NIVEAU INT,@ABREVIATION VARCHAR(5),@LETTRE VARCHAR(1))
	 AS
	 BEGIN
	 ...
	 SELECT * FROM COURS
	 UPDATE COURS SET DESIGNATION='INFORMATIQUE' WHERE ID=12
	   SELECT * FROM COTATION
...
ALTER PROC CHERCHE_NOMBRE_HEURE_DEJA_PROGRAMME(
@COURS VARCHAR(25),@NIVEAU INT,@ABREVIATION VARCHAR(5), @DESIGNATION VARCHAR(2)
)
AS 
BEGIN
DECLARE @LUNDI INT,@MARDI INT,@MERCREDI INT,@JEUDI INT,@VENDREDI INT,@SAMEDI INT

	SELECT @LUNDI=COUNT(*) FROM PROGRAMME_ENSEIGNEMENT INNER JOIN AFFECTATION_COURS ON AFFECTATION_COURS.ID=PROGRAMME_ENSEIGNEMENT.LUNDI INNER JOIN
	 HORAIRE ON HORAIRE.ID=AFFECTATION_COURS.HORAIRE
	INNER JOIN COURS ON COURS.ID=HORAIRE.COURS AND AFFECTATION_COURS.DESIGNATION_SALLE=PROGRAMME_ENSEIGNEMENT.designation_salle INNER JOIN DESIGNATION_SALLE ON DESIGNATION_SALLE.ID=PROGRAMME_ENSEIGNEMENT.designation_salle
	INNER JOIN SALLE ON SALLE.ID=DESIGNATION_SALLE.ID_SALLE INNER JOIN SECTION ON SECTION.ID=SALLE.SECTION
WHERE SALLE.NIVEAU_ETUDE=@NIVEAU AND SECTION.ABREVIATION=@ABREVIATION AND DESIGNATION_SALLE.LETTRE=@DESIGNATION AND COURS.DESIGNATION=@COURS
	
	SELECT @MARDI= COUNT(*) FROM PROGRAMME_ENSEIGNEMENT INNER JOIN AFFECTATION_COURS ON AFFECTATION_COURS.ID=PROGRAMME_ENSEIGNEMENT.MARDI INNER JOIN
	 HORAIRE ON HORAIRE.ID=AFFECTATION_COURS.HORAIRE
	INNER JOIN COURS ON COURS.ID=HORAIRE.COURS AND AFFECTATION_COURS.DESIGNATION_SALLE=PROGRAMME_ENSEIGNEMENT.designation_salle INNER JOIN DESIGNATION_SALLE ON DESIGNATION_SALLE.ID=PROGRAMME_ENSEIGNEMENT.designation_salle
	INNER JOIN SALLE ON SALLE.ID=DESIGNATION_SALLE.ID_SALLE INNER JOIN SECTION ON SECTION.ID=SALLE.SECTION
WHERE SALLE.NIVEAU_ETUDE=@NIVEAU AND SECTION.ABREVIATION=@ABREVIATION AND DESIGNATION_SALLE.LETTRE=@DESIGNATION AND COURS.DESIGNATION=@COURS
	
	SELECT @MERCREDI= COUNT(*) FROM PROGRAMME_ENSEIGNEMENT INNER JOIN AFFECTATION_COURS ON AFFECTATION_COURS.ID=PROGRAMME_ENSEIGNEMENT.MERCREDI INNER JOIN
	 HORAIRE ON HORAIRE.ID=AFFECTATION_COURS.HORAIRE
	INNER JOIN COURS ON COURS.ID=HORAIRE.COURS AND AFFECTATION_COURS.DESIGNATION_SALLE=PROGRAMME_ENSEIGNEMENT.designation_salle INNER JOIN DESIGNATION_SALLE ON DESIGNATION_SALLE.ID=PROGRAMME_ENSEIGNEMENT.designation_salle
	INNER JOIN SALLE ON SALLE.ID=DESIGNATION_SALLE.ID_SALLE INNER JOIN SECTION ON SECTION.ID=SALLE.SECTION
WHERE SALLE.NIVEAU_ETUDE=@NIVEAU AND SECTION.ABREVIATION=@ABREVIATION AND DESIGNATION_SALLE.LETTRE=@DESIGNATION AND COURS.DESIGNATION=@COURS
	...
	SELECT @JEUDI= COUNT(*) FROM PROGRAMME_ENSEIGNEMENT INNER JOIN AFFECTATION_COURS ON AFFECTATION_COURS.ID=PROGRAMME_ENSEIGNEMENT.JEUDI INNER JOIN
	 HORAIRE ON HORAIRE.ID=AFFECTATION_COURS.HORAIRE
	INNER JOIN COURS ON COURS.ID=HORAIRE.COURS AND AFFECTATION_COURS.DESIGNATION_SALLE=PROGRAMME_ENSEIGNEMENT.designation_salle INNER JOIN DESIGNATION_SALLE ON DESIGNATION_SALLE.ID=PROGRAMME_ENSEIGNEMENT.designation_salle
	INNER JOIN SALLE ON SALLE.ID=DESIGNATION_SALLE.ID_SALLE INNER JOIN SECTION ON SECTION.ID=SALLE.SECTION
WHERE SALLE.NIVEAU_ETUDE=@NIVEAU AND SECTION.ABREVIATION=@ABREVIATION AND DESIGNATION_SALLE.LETTRE=@DESIGNATION AND COURS.DESIGNATION=@COURS
	...
	SELECT @VENDREDI= COUNT(*) FROM PROGRAMME_ENSEIGNEMENT INNER JOIN AFFECTATION_COURS ON AFFECTATION_COURS.ID=PROGRAMME_ENSEIGNEMENT.VENDREDI INNER JOIN
	 HORAIRE ON HORAIRE.ID=AFFECTATION_COURS.HORAIRE
	INNER JOIN COURS ON COURS.ID=HORAIRE.COURS AND AFFECTATION_COURS.DESIGNATION_SALLE=PROGRAMME_ENSEIGNEMENT.designation_salle INNER JOIN DESIGNATION_SALLE ON DESIGNATION_SALLE.ID=PROGRAMME_ENSEIGNEMENT.designation_salle
	INNER JOIN SALLE ON SALLE.ID=DESIGNATION_SALLE.ID_SALLE INNER JOIN SECTION ON SECTION.ID=SALLE.SECTION
WHERE SALLE.NIVEAU_ETUDE=@NIVEAU AND SECTION.ABREVIATION=@ABREVIATION AND DESIGNATION_SALLE.LETTRE=@DESIGNATION AND COURS.DESIGNATION=@COURS
	...
	SELECT @SAMEDI= COUNT(*) FROM PROGRAMME_ENSEIGNEMENT INNER JOIN AFFECTATION_COURS ON AFFECTATION_COURS.ID=PROGRAMME_ENSEIGNEMENT.SAMEDI INNER JOIN
	 HORAIRE ON HORAIRE.ID=AFFECTATION_COURS.HORAIRE
	INNER JOIN COURS ON COURS.ID=HORAIRE.COURS AND AFFECTATION_COURS.DESIGNATION_SALLE=PROGRAMME_ENSEIGNEMENT.designation_salle INNER JOIN DESIGNATION_SALLE ON DESIGNATION_SALLE.ID=PROGRAMME_ENSEIGNEMENT.designation_salle
	INNER JOIN SALLE ON SALLE.ID=DESIGNATION_SALLE.ID_SALLE INNER JOIN SECTION ON SECTION.ID=SALLE.SECTION
WHERE SALLE.NIVEAU_ETUDE=@NIVEAU AND SECTION.ABREVIATION=@ABREVIATION AND DESIGNATION_SALLE.LETTRE=@DESIGNATION AND COURS.DESIGNATION=@COURS
...
SELECT @LUNDI+@MARDI+@MERCREDI+@JEUDI+@VENDREDI+@SAMEDI

END

EXEC CHERCHE_NOMBRE_HEURE_DEJA_PROGRAMME 'INFORMATIQUE',1,'CO','A'

select * from PROGRAMME_ENSEIGNEMENT

UPDATE PROGRAMME_ENSEIGNEMENT SET LUNDI=NULL,MARDI=NULL,MERCREDI=NULL,JEUDI=NULL,VENDREDI=NULL,SAMEDI=NULL